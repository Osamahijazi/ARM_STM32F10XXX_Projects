...
***********************************************************************************************************************************************************************************************************************************************************/																			
uint8 ERROR ;               /*THIS VARIABLE SHOULD HOLD A VALUE THAT INDICATE THE TYPE AND LOCATION OF ERROR ACCORDING TO THE FOLOOWING TABLE*/
/*
 VALUE ***** VARIABLE_NAME **** EUNCTION_NAME** 
  1    *****    PIN        **** SET_PIN_DIRECTION 
  2    *****    PIN        **** SET_PIN_VALUE
  3    *****    PORT       **** SET_PORT_VALUE
  4    *****    PIN        **** GET_PIN_VALUE
  5    *****    PORT       **** GET_PORT_VALUE
	6    *****    PIN        **** TOOGLE_PIN_VAKUE
	7    *****    PIN        **** LOCK_PIN_CONFIG
*/
/***********************************************************************************************************************************************************************************************************************************************************
                                                *******FUNCTIONS PROTOTYPE******
***********************************************************************************************************************************************************************************************************************************************************/																			
