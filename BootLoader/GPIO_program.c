...
static uint8 GPIO_ERROR = 0  ;  /*THIS VARIABLE SHOULD HOLD A VALUE THAT INDICATE THE TYPE AND LOCATION OF ERROR*/
/***********************************************************************************************************************************************************************************************************************************************************/
 ...
 switch (Copy_u8Port)                                                 /*CHOOSE A CERTAIN PORT {A,B,C}*/
  {
   ...
   case GPIOC :                                                                                  /*SET MODE OF PINS OF PORT B*/
	...
	default   :				
                		GPIO_ERROR = WRONG_PORT_NUMBER_SET_MODE ;                    /* IF THERE IS ANY RUNTIME ERROR , WATCH THIS VAR IN DEBUG SESSION */
		                break;
  ...
  switch (Copy_u8Port)                                            /*CHOOSE A CERTAIN PORT {A,B,C}*/
    ...
    case GPIOC :                                                  /*SET VALUE TO A PIN OF PORT C*/
                    ...
                    if (Copy_u8Value == GPIO_LOW){                /*RESET VALUE TO A PIN OF PORT C*/
	                 ...
	                 break;
		default   :				
                		GPIO_ERROR = WRONG_PORT_NUMBER_SET_PIN ;                    /* IF THERE IS ANY RUNTIME ERROR , WATCH THIS VAR IN DEBUG SESSION */
		                break;						
                                                 /*END OF SWITCH CASE*/
	}
...
void GPIO_voidSetPortValue (uint8  Copy_u8Port,
	...
	switch (Copy_u8Port) {                                                  /*CHOOSE A CERTAIN PORT {A,B,C}*/  
		...
		default    : 
			GPIO_ERROR = WRONG_PORT_NUMBER_SET_PORT ;   break ;                   /* IF THERE IS ANY RUNTIME ERROR , WATCH THIS VAR IN DEBUG SESSION */
...
uint8 Result_Value = 0 ;                                     /*LOCAL VARIABLE TO SAVE THE VALUE*/
    ...
    case GPIOC :
		...
		default   :				
                		GPIO_ERROR = WRONG_PORT_NUMBER_GET_PIN ;                    /* IF THERE IS ANY RUNTIME ERROR , WATCH THIS VAR IN DEBUG SESSION */
		                break;
       	}		
    return Result_Value;
				                                     /*END OF SWITCH CASE*/	
...
uint16 Result_Value = 0 ;                                     /*LOCAL VARIABLE TO SAVE THE VALUE*/
    ...
    case GPIOC :
                   Result_Value = GPIOC_IDR;  break;                  /*SET VALUE OF A CERTAIN PIN IN PORT C*/
	                                                                        /* Result_Value = PIN VALUE*/
		default   :				
                		GPIO_ERROR = WRONG_PORT_NUMBER_GET_PORT ;                    /* IF THERE IS ANY RUNTIME ERROR , WATCH THIS VAR IN DEBUG SESSION */
		                break;				
	}	            
                								 /*END OF SWITCH CASE*/
	   return Result_Value;
...
void GPIO_voidTogglePinValue (uint8 Copy_u8Port,
	...
	switch (Copy_u8Port) {                                                         /*CHOOSE A CERTAIN PORT {A,B,C}*/
	 ...
	 case GPIOC : 
			            ...
			            break ; 
                                                                                  /*THE PIN = Copy_u8Pin */
		default   :   GPIO_ERROR = WRONG_PORT_NUMBER_TOGGLE_PIN ;
            			break ;	 				                                     
	}
	                                              /*END OF SWITCH CASE*/
}
...
void GPIO_voidLockPinConfig(uint8 Copy_u8Port,                          /*LOCK A CERTAIN PIN IN A CERTAIN PORT*/
	...
	uint32 LCK_VALUE = 0;       
	 ...
	 switch (Copy_u8Port) {                          /*CHOOSE A CERTAIN PORT {A,B,C}*/
       ...
       GPIO_ERROR = WRONG_PORT_NUMBER_LOCK_PIN ;			 /*IF YOU ARE HER , THEN YOU CHOOSE AWRONG PIN OR WRONG PORT MACRO*/
