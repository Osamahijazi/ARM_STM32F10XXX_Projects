...
CAN_FilterInitTypeDef  CAN_FilterInitStruct_3 = { 0x00200000 , 0x00200000 , CAN_FilterMode_IdList ,  3  , CAN_FilterScale_32bit , CAN_Filter_FIFO0 , ENABLE}; // ID = 0x01
...
CanRxMsg   RxxMessage ;
      ...
      NVIC_voidEnableInterrupt (USB_LP_CAN_RX0); //enable interrupt for CAN1-RX
 ...
 CAN_VoidInterruptSet(CAN1, CAN_FMPIE0 , ENABLE) ; /*message pending interrupt*/
   ...
   CAN_VoidFilterSet( & CAN_FilterInitStruct_3 );
